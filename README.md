...
> iCooker是用Dart语言构建的一款Flutter版美食APP，该APP参考模板是号称“拥有两千万用户的美食APP--美食杰”，主要页面布局参考模板APP，但也有所改动，应用所使用的api均为抓包所得，**因涉及到目前模板APP是商业APP，未避免产生不必要的法律纠纷故本开源项目中的API地址未打包上传，如需API请自行想办法解决(你懂的！)** 。  
